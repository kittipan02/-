...
<head>
    ...
    <script>
        function confirmDelete(requestId) {
            ...
            if (result) {
                ...
                window.location = "repair_sale_history.php?delete_id=" + requestId;
            }
        }
    </script>
    <?php
    if (isset($_GET['delete_id'])) {
        ...
        if ($conn->query($deleteQuery) === TRUE) {
            ...
            echo "<script>window.location.href = 'repair_sale_history.php';</script>";
        } else {
...
<body>
    ...
    WHERE (rs.rs_name = 'จำหน่ายเสร้จสิ้น') AND (rr.equipment_number LIKE '%$search%' OR rr.item LIKE '%$search%' OR dp.dp_name LIKE '%$search%' OR u.u_fname LIKE '%$search%' OR u.u_lname LIKE '%$search%' OR et.et_name LIKE '%$search%' OR b.brand_name LIKE '%$search%' OR rr.repair_details LIKE '%$search%')
